...
namespace Лаб_4
{
    class main_menu
    {
            ...
            try
            {
                switch (searchChoice)
                {
                    case 1:
                        ...
                        try
                        {
                            IName itemByIndex = products[index - 1];
                    ...
                    case 2:
                        ...
                        try
                        {
                            IName itemByName = products[name];
                            AnsiConsole.MarkupLine("[green]Знайдено продукт:[/]");
        ...
        private static void DisplayProductDetails(IName item)
        {
        ...
        private static void InsertProductAtPosition(IName product)
        {
            if (products.Count > 0)
            {
        ...
        private static void GenerateRandomProducts()
        {
            ...
            {
                IName product = (IName)RandomProductGenerator.GenerateRandomProduct();
                if (positionChoice == 1)
                {
        ...
        private static void RemoveProductByIndex()
        {
            ...
            try
            {
                ...
                IName itemToRemove = products[index - 1];

...
class Program
{
    ...
    private static void menu() {
        while (true)
        {
            ...
            AnsiConsole.MarkupLine("[red]7.[/] Вийти");
            AnsiConsole.Markup("[grey]Введіть ваш вибір (1-7): [/]");

            int choice;
            while (!int.TryParse(Console.ReadLine(), out choice) || choice < 1 || choice > 7)
            {
                AnsiConsole.Markup("[red]Некоректне введення.[/] Будь ласка, введіть [yellow]1-7[/]: ");
            }

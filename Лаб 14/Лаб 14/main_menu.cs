...
namespace Лаб_4
{
    class main_menu
    {
        ...
        public static void Main_menu()
        {
            ...
            while (true)
            {
                ...
                AnsiConsole.MarkupLine("[darkcyan]14.[/] Показати загальну вартість товарів");
                AnsiConsole.MarkupLine("[darkcyan]15.[/] LINQ: Найдешевший та найдорожчий товар");
                AnsiConsole.MarkupLine("[darkgreen]16.[/] LINQ: Середня вартість за категоріями");
                AnsiConsole.MarkupLine("[red]17.[/] Вийти");

                int choice;
                while (!int.TryParse(Console.ReadLine(), out choice) || choice < 1 || choice > 17)
                {
                    AnsiConsole.Markup("[red]Некоректне введення.[/] Будь ласка, введіть [yellow]1-17[/]: ");
                }
        ...
        private static void DisplayProductDetails(Product item)
        {
            ...
            switch (product)
            {
                case MedicalMagazine medical:
                    ...
                    AnsiConsole.MarkupLine($"[bold]Рецензований:[/] [hotpink]{(medical.IsPeerReviewed ? "Так" : "Ні")}[/]");
                    break;
                ...
                case Novel novel:
                    ...
                    AnsiConsole.MarkupLine($"[bold]Стиль:[/] [gold1]{novel.NarrativeStyle.EscapeMarkup()}[/]"); 
                    break;
                ...
                case Biography biography:
                    ...
                    AnsiConsole.MarkupLine($"[bold]Структура:[/] [steelblue]{biography.Structure.EscapeMarkup()}[/]"); 
                ...
                case AstrophysicsMagazine astroMag:
                    ...
                    AnsiConsole.MarkupLine($"[bold]Дослідження:[/] [royalblue1]{astroMag.AuthoritativeResearch.EscapeMarkup()}[/]"); 
                    break;
                ...
                case FashionMagazine fashionMag:
                    ...
                    AnsiConsole.MarkupLine($"[bold]Інтерв'ю:[/] [orchid]{fashionMag.ExclusiveInterviews.EscapeMarkup()}[/]");
                    break;
                ...
                case Textbook textbook:
                    ...
                    AnsiConsole.MarkupLine($"[bold]Клас:[/] [orange3]{textbook.GradeLevel.EscapeMarkup()}[/]");
                ...
                case ShortStoryCollection storyCollection:
                    ...
                    AnsiConsole.MarkupLine($"[bold]Тематична:[/] [lightcoral]{(storyCollection.IsThematic ? "Так" : "Ні")}[/]");
                ...
                case TravelMagazine travelMag:
                    ...
                    AnsiConsole.MarkupLine($"[bold]Путівник:[/] [tan]{(travelMag.HasTravelGuides ? "Так" : "Ні")}[/]");
    ...
    : new LinkedListContainer<Product>();
        ...
        private static void RenderProductsTable(IEnumerable<Product> itemsToDisplay) {
            ...
            table.AddColumn(new TableColumn("[bold blue2]Тип публікації[/]").LeftAligned());
        ...
        private static void SaveContainerToFile()
        {
            ...
            products.SaveToBinaryFile(path);

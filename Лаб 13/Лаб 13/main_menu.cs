    ...
    class main_menu
    {
        ...
        public static void Main_menu()
        {
            ...
            while (true)
            {
                ...
                AnsiConsole.MarkupLine("[red]15.[/] Вийти");

                int choice;
                while (!int.TryParse(Console.ReadLine(), out choice) || choice < 1 || choice > 15)
                {
                    AnsiConsole.Markup("[red]Некоректне введення.[/] Будь ласка, введіть [yellow]1-15[/]: ");
                }
